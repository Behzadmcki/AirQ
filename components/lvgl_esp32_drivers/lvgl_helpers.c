 ...
 *      TYPEDEFS
 **********************/
//enum spi_host_device_t TFT_SPI_HOST;
...
/* Display controller initialization */
	...
	lvgl_spi_driver_init(1,
			DISP_SPI_MISO, DISP_SPI_MOSI, DISP_SPI_CLK,
			SPI_BUS_MAX_TRANSFER_SZ, 1,
			DISP_SPI_IO2, DISP_SPI_IO3);

	disp_spi_add_device(1);
	ESP_LOGI(TAG, "ghabl az Disp driver  ");

	disp_driver_init();
	ESP_LOGI(TAG, "bad az Disp driver  ");
